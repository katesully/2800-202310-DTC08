...
* Sometimes a correct login leads to a 401 error, and then when you click on the button to try logging in again, the user is validated and proceeds to the main chat page.
